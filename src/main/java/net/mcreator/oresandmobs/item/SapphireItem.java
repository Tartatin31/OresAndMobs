...
public class SapphireItem extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:sapphire")
	public static final Item block = null;
	public SapphireItem(OresandmobsModElements instance) {
		super(instance, 1);
	}
