...
public class Swamp_WoodLogBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_log")
	public static final Block block = null;
	public Swamp_WoodLogBlock(OresandmobsModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("swamp_wood_log");
		}
