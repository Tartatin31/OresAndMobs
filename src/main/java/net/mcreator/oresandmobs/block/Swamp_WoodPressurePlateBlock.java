...
public class Swamp_WoodPressurePlateBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_pressure_plate")
	public static final Block block = null;
	public Swamp_WoodPressurePlateBlock(OresandmobsModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("swamp_wood_pressure_plate");
		}
