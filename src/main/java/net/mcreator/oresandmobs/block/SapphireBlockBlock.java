...
public class SapphireBlockBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:sapphire_block")
	public static final Block block = null;
	public SapphireBlockBlock(OresandmobsModElements instance) {
		super(instance, 3);
	}
