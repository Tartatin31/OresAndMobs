...
public class Swamp_WoodFenceGateBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_fence_gate")
	public static final Block block = null;
	public Swamp_WoodFenceGateBlock(OresandmobsModElements instance) {
		super(instance, 33);
	}
