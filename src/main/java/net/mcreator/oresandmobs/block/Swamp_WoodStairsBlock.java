...
public class Swamp_WoodStairsBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_stairs")
	public static final Block block = null;
	public Swamp_WoodStairsBlock(OresandmobsModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("swamp_wood_stairs");
		}
