...
public class Swamp_WoodWoodBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_wood")
	public static final Block block = null;
	public Swamp_WoodWoodBlock(OresandmobsModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("swamp_wood_wood");
		}
