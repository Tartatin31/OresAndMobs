...
public class Swamp_WoodFenceBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_fence")
	public static final Block block = null;
	public Swamp_WoodFenceBlock(OresandmobsModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("swamp_wood_fence");
		}
