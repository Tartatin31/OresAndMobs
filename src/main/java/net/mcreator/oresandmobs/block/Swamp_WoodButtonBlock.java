...
public class Swamp_WoodButtonBlock extends OresandmobsModElements.ModElement {
	@ObjectHolder("oresandmobs:swamp_wood_button")
	public static final Block block = null;
	public Swamp_WoodButtonBlock(OresandmobsModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("swamp_wood_button");
		}
